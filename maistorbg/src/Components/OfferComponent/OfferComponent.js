...
//         .filter(job => job.jobAdvertisementId === offer.jobAdvertisementId);
...
//     const allOffers = JSON.parse(localStorage.getItem("allOffers"));
//     const filteredOffers = allOffers.filter((job) => job.jobAdvertisementId === offer.jobAdvertisementId);
...
//                 Детайли
//               </button>
//               {JSON.parse(localStorage.getItem("allOffers"))
//                 .filter((job) => job.jobAdvertisementId === offer.jobAdvertisementId)
//                 .map((jobOffer) => (
